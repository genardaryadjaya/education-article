...
<?php $component->withAttributes([]); ?>
    ...
    <div class="container mx-auto py-4">
        <form action="<?php echo e(route('artikel.store')); ?>" method="POST" enctype="multipart/form-data" class="max-w-2xl bg-white p-6 rounded shadow">
            <?php echo csrf_field(); ?>
            <div class="mb-4">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-4">
                <label class="flex items-center">
                    <input type="checkbox" name="publish" class="mr-2" <?php echo e(old('publish') ? 'checked' : ''); ?>>
...
<?php endif; ?> <?php /**PATH C:\laragon\www\manajemendatasiswa\resources\views/artikel/create.blade.php ENDPATH**/ ?>