...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mt-6 text-center">
                    <p class="text-gray-600">
                        Sudah punya akun? 
                        <a href="<?php echo e(route('login')); ?>" class="text-green-600 hover:text-green-800 font-medium transition duration-200">
                            Masuk di sini
                        </a>
                    </p>
                </div>
            ...
            <div class="text-center mt-8">
                <p class="text-gray-500 text-sm">
                    © <?php echo e(date('Y')); ?> Website Artikel Edukasi. Dibuat dengan ❤️
                </p>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\laragon\www\manajemendatasiswa\resources\views/auth/register.blade.php ENDPATH**/ ?>